...
export const env = createEnv({
  ...
  server: {
    ...
    SMTP_PASSWORD1: z.string(),
    SMTP_EMAIL2: z.string().email(),
    SMTP_PASSWORD2: z.string(),
    SMTP_EMAIL3: z.string().email(),
    SMTP_PASSWORD3: z.string(),
    SMTP_EMAIL4: z.string().email(),
    SMTP_PASSWORD4: z.string(),
    SMTP_EMAIL5: z.string().email(),
    SMTP_PASSWORD5: z.string(),
  ...
  runtimeEnvStrict: {
    ...
    SMTP_PASSWORD1: process.env.SMTP_PASSWORD1,
    SMTP_EMAIL2: process.env.SMTP_EMAIL2,
    SMTP_PASSWORD2: process.env.SMTP_PASSWORD2,
    SMTP_EMAIL3: process.env.SMTP_EMAIL3,
    SMTP_PASSWORD3: process.env.SMTP_PASSWORD3,
    SMTP_EMAIL4: process.env.SMTP_EMAIL4,
    SMTP_PASSWORD4: process.env.SMTP_PASSWORD4,
    SMTP_EMAIL5: process.env.SMTP_EMAIL5,
    SMTP_PASSWORD5: process.env.SMTP_PASSWORD5,
