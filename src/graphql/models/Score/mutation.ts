...
builder.mutationField("addScore", (t) =>
  t.prismaField({
    ...
    resolve: async (query, root, args, ctx, info) => {
      ...
      if (isJudgeOfRound.length === 0) throw new Error("Not Authorized");

      try {
        return await ctx.prisma.scores.upsert({
          where: {
        ...
        console.log(e);
        throw new Error("Something went wrong! Couldn't add score");
      }
    },
  }),
);
...
builder.mutationField("addComment", (t) =>
  t.prismaField({
    ...
    resolve: async (query, root, args, ctx, info) => {
      ...
      try {
        return await ctx.prisma.comments.upsert({
          where: {
        ...
        console.log(e);
        throw new Error("Something went wrong! Couldn't add comment");
      }
    },
  }),
);
